...
Lux::Core::Internal::MeshOGL::MeshOGL() : Mesh(),
m_VertexArray(),
...
Lux::Core::Internal::MeshOGL::MeshOGL(const MeshOGL& a_SubMesh) : Mesh(a_SubMesh),
m_VertexArray(),
m_IndexBuffer(GL_ELEMENT_ARRAY_BUFFER, GL_STATIC_DRAW),
m_VertexBuffer(GL_ARRAY_BUFFER, GL_STATIC_DRAW)
{
...
Lux::Core::Internal::MeshOGL::MeshOGL(aiMesh& a_Mesh) : Mesh(a_Mesh),
m_VertexArray(),
m_VertexBuffer(GL_ARRAY_BUFFER, GL_STATIC_DRAW),
m_IndexBuffer(GL_ELEMENT_ARRAY_BUFFER, GL_STATIC_DRAW)
{
...
void Lux::Core::Internal::MeshOGL::PreRender()
{
	m_VertexArray.Bind();
}

void Lux::Core::Internal::MeshOGL::PostRender()
{
	m_VertexArray.Unbind();
}
